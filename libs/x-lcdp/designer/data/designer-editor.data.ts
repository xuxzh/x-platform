export const xEditorLibDeclaration = `declare type RhSafeAny = any;
declare type WithNil<T> = T | null | undefined;

declare const $:LocalSpace;
declare const $self:RhBasicFormItemDto;
declare const $props:BasicFormItemConfigDto;
declare const $deps:RhSafeAny;
declare const R:RhRuntime;
declare const d:RhSafeAny;
declare const target:RhSafeAny;

/** formItem模型 */
interface RhBasicFormItemDto {
    /** 数据值 */
    value: string;
}

/** formItem模型 */
interface RhBasicFormItemConfigDto extends RhComponentFieldSettingDto {
  /** 键值 */
  fieldKey: string;
  /** 键名 */
  fieldName: string;
  ...
  rhDisabled: boolean;
  /** 占位符 */
  rhPlaceholder: string;
  /** 分组编码 */
  groupKey?: string;
  /** 分组名称 */
  groupName?: string;
  /** 分组所属表单键值 */
  groupByFormKey?: string;
}
...
/** 当前字段属性获取 */
type BasicFormItemConfigDto = RhBasicFormItemConfigDto;
/** 运行环境 */
...
declare class RhRuntimeService<D> extends RhAbstractRuntime<D> {
    ...
    constructor(http: HttpClient, router: Router, apiService: RhApiConfigService, storageService: RhStorageService, opHandlers: RhOpHandlersDataset, operations: RhOperationsDataset);
